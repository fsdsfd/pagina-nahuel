...
const Terminos = () => {
  return (
    <div className='container-terminos'>
      <h1 className='h1-principal'>Términos y condiciones</h1>
      <div className='container-terminos__inner'>
        <ol type='1'>
          <li className='li'>
            <h1 className='h1'>Introducción:</h1>
          Las presentes condiciones generales de uso de la página web, regulan los términos y condiciones de acceso y uso de [nombre de tu empresa].com.ar , propiedad de [nombre de tu empresa], con domicilio en Cafferata 3226, en adelante, «la Empresa», que el usuario del Portal deberá de leer y aceptar para usar todos los servicios e información que se facilitan desde el portal. El mero acceso y/o utilización del portal, de todos o parte de sus contenidos y/o servicios significa la plena aceptación de las presentes condiciones generales de uso.</li>
          <li className='li'>
            <h1 className='h1'>Condiciones de uso:</h1>
          Las presentes condiciones generales de uso del portal regulan el acceso y la utilización del portal, incluyendo los contenidos y los servicios puestos a disposición de los usuarios en y/o a través del portal, bien por el portal, bien por sus usuarios, bien por terceros. No obstante, el acceso y la utilización de ciertos contenidos y/o servicios puede encontrarse sometido a determinadas condiciones específicas.</li>
          <li className='li'>
            <h1 className='h1'>Modificaciones:</h1>
          La empresa se reserva la facultad de modificar en cualquier momento las condiciones generales de uso del portal. En todo caso, se recomienda que consulte periódicamente los presentes términos de uso del portal, ya que pueden ser modificados.</li>
          <li className='li'>
            <h1 className='h1'>Obligaciones del Usuario:</h1>
...
En todo caso, el Portal excluye cualquier responsabilidad por los daños y perjuicios que puedan deberse a la información y/o servicios prestados o suministrados por terceros diferentes de la Empresa. Toda responsabilidad será del tercero ya sea proveedor o colaborador.</li>
          <li className='li'>
            <h1 className='h1'>Propiedad intelectual e industrial:</h1>
...
En cualquier caso, el portal se reserva todos los derechos sobre los contenidos, información datos y servicios que ostente sobre los mismos. El portal no concede ninguna licencia o autorización de uso al usuario sobre sus contenidos, datos o servicios, distinta de la que expresamente se detalle en las presentes condiciones generales de uso del portal.
          ...
          <li className='li'>
            <h1 className='h1'>Legislación aplicable, jurisdicción competente y notificaciones:</h1>
            
          Las presentes condiciones se rigen y se interpretan de acuerdo con las Leyes de la República Argentina. Para cualquier reclamación serán competentes los juzgados y tribunales de Rosario. Todas las notificaciones, requerimientos, peticiones y otras comunicaciones que el Usuario desee efectuar a la Empresa titular del Portal deberán realizarse por escrito y se entenderá que han sido correctamente realizadas cuando hayan sido recibidas en la siguiente dirección: Cafferata 3226, Rosario.</li>
        </ol>
      </div>
    </div>
  )
